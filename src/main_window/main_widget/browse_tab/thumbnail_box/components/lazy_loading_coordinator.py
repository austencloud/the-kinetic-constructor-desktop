...
class LazyLoadingCoordinator(QObject):
    ...
    def __init__(self, widget: QWidget):
        ...
        self._fallback_delay_ms = 5000  # 5 second fallback timeout
    ...
    def request_image_load(self, image_path: str, target_size: QSize, 
                          load_callback: Callable[[str, QPixmap], None]) -> bool:
        """
    ...
    def _trigger_fallback(self) -> None:
        ...
        if self._pending_path:
            logging.warning(f"Lazy loading timeout, triggering fallback: {self._pending_path}")
    ...
    def is_in_loading_zone(self) -> bool:
        ...
        try:
            return self._lazy_loader.viewport_manager.is_widget_in_loading_zone(self.widget)
        except Exception as e:
