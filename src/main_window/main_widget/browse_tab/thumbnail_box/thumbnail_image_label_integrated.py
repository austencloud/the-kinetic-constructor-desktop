"""
Thumbnail Image Label with Maximum Display Integration.
...
class ThumbnailImageLabelIntegrated(QLabel):
    """
    Thumbnail image label with maximum display area.
    ...
    def __init__(self, thumbnail_box: "ThumbnailBoxIntegrated"):
    ...
    def _setup_styling(self):
        ...
        # CRITICAL FIX: Proper alignment to prevent vertical positioning issues
        ...
        self.setObjectName("thumbnail_image_enhanced")

    def _setup_properties(self):
        """Setup label properties."""
        # Alignment already set in _setup_styling() to prevent duplication
    ...
    def _calculate_main_view_maximum(self) -> QSize:
        ...
        # CRITICAL FIX: Use 100% of container width for image labels
        # Remove padding deduction to fill full container width
        available_width = container_width

        # Use 100% of available container space for maximum display
        image_width = int(available_width * 1.0)  # 100% utilization
        ...
        # CRITICAL FIX: Strict height constraints to prevent overflow
        image_height = max(
            120, min(image_height, 150)
        )  # Max 150px height to prevent overflow
